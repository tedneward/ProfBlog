...
**Is yours a company that needs a DevRel team?** [Yes.](../blog/2022/devrel-for-all-companies.html) It's really just that simple.

**Are you not sure where the DevRel team fits in your organization?** 

* [Here's my answer.](../blog/2023/where-devrel-fits.html) Short answer, it belongs as a top-level organization reporting in to the C-suite, right alongside Engineering, Sales, and Marketing. 
* [Kim Maida has her own ideas on this](https://maida.kim/which-department-does-developer-relations-belong-in/), but in the end she seems to agree with the basic premise of my belief as well: "Developer Relations, as a key discipline, has earned its place at the leadership table."

## Activities

The [DevRel Activity Pattern Language](activities/index.html) provides a pattern language for all the activities a DevRel team can/might/will do during its existence. It grew out of several of the links below. EDIT: As of March 2026, it's now in [dead-trees, greatly-expanded form](https://link.springer.com/book/10.1007/979-8-8688-1895-0).
...
Personally, I think that's a good start on an ontology of DevRel activities, but I think it's not complete; I flesh out my own ontology [here](../blog/2023/dev-rel-ontology.html).

[Kim Maida](https://maida.kim/) talks about ["How to Drive Developer Growth and Engagement"](https://maida.kim/how-to-drive-developer-growth-and-engagement/), as well as ["How to Connect with your Developer Audience"](https://maida.kim/how-to-build-developer-audience/), which is a little more touchy-feely: "Act with integrity and empathy", "Build trust and respect", and "Inspire Loyalty and Confidence".

## Metrics

[Kim Maida](https://maida.kim/) weighs in on ["How to Measure the Value of Developer Relations"](https://maida.kim/how-to-measure-the-value-of-developer-relations/)

Mary Thengvall talks about ["The Hidden Value Developer Relations Teams Provide"](https://martechseries.com/mts-insights/guest-authors/the-hidden-value-developer-relations-teams-provide/), wherein she describes the value the DevRel team can bring, albeit without anything quantifiable that one can take away directly.