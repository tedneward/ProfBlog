...
***tl;dr*** In the Blackboard pattern several specialized subsystems assemble their knowledge to bulld a possibly partial or approximate solution.
...
A special knowledge source or a procedure in the control component determines when the system should halt, and what the final result is. The system halts when an acceptable7 hypothesis is found, or when the space or time resources of the system are exhausted.
