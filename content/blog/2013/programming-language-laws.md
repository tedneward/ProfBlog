...
date=2013-03-19
type=post
tags=industry, languages, reading
status=published
description=In which I look at Mozart, Oz, and the laws of programming languages.
~~~~~~
As is pretty typical for that site, Lambda the Ultimate has <a href="http://lambda-the-ultimate.org/node/4698">a great discussion</a> on some insights that the creators of Mozart and Oz have come to, regarding the design of programming languages; I repeat the post here for convenience:
