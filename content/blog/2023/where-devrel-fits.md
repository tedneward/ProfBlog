...
By now, it's frustratingly clear that there's really no good place in which the DevRel team can live inside of most organizations. This is because "Developer Relations" is a discipline that crosses multiple boundaries, and isn't a "sub-category" or "specialization" of one of the other discplinary areas (like Engineering, Marketing, or Sales).

In fact, it almost feels like it's its own discpline, like how Legal Affairs has to be its own organization within the company, connecting and being available to each and every other group. Or Accounting, or Public Relations.

And that's when the light comes on: *Developer Relations needs to be its own top-level organization within the company.*
...
The DevRel team being at a level reporting directly into the C-Suite (alongside the VP of Marketing, VP of Engineering, and VP of Sales) means that now the VP of DevRel establishes high-level goals and metric targets suitable for the team, but in conjunction with the overall goals of the company as a whole. If the company needs to make a major Marketing push because Engineering is releasing a new version, DevRel can adjust goals to provide tutorials and samples, as well as work directly with Marketing to get the Dev Advocates out into conferences and podcasts to talk about the new release and features. It can allocate some time to go with the Sales folks to help sell the new version. And so on.

If the thought seems too far-fetched, consider this: There was a time when Legal wasn't a formal part of the organization, and when Sales and Marketing were combined into one group. In fact, there was a time when anything "computer-related" fell under the auspices of operations, and there was no differentiation between Development and IT/Operations/Administration. And Procurement was simply whomever in Accounting you could ask to buy you something. And so on.
