...
Meanwhile, among [my 2022 predictions](../2022/2022-tech-predictions)....

* "***5G rollout is going to be a lot more contentious than we expected."***
...
* "***Demand for full-stack developers will continue to leave companies high-and-dry."***
    ...
    * "**Work-from-home will become normalized as part of the landscape."**
    ...
    * **"Companies will start "growing" their own developer staff."**
    ...
    * **"Automation tools and platforms will climb in use."**

        **Result: +1.** I'll give myself a point here, but let me be clear: There is *no way* I was thinking anything along the lines of ChatGPT or OpenAI or any of that stuff. I mean... wow.

    * **"No-code/low-code tools and platforms will surge."**
    ...
    * **"Developer market will grow. Slowly."**
    ...
    * **"Job descriptions will emphasize more about skills (including human skills) and less on degrees/certifications."**
...
* ***"Remote tooling vendors will look to improve."*** (0.6)
...
* ***"'Older' tech will start to see a surge of interest and rise in adoption."***
...
* ***"Theranos will teach us something... but we'll not be sure exactly what."***

    **Result: +1.** [Elizabeth Holmes got 11 years](https://www.theguardian.com/us-news/2022/nov/18/elizabeth-holmes-theranos-trial-sentencing) (appeals pending). Her partner got 13 (again, appeals pending). Clearly "the system" wanted to send a message about fraudulent claims around startups, but overall, the reaction in the startup world has been... mixed. There's still the incessant hype around Miracle Founders (I mean, how much more smoke do we need to blow up Elon's ass already?), and much is being written, even as little is being done. Hate to give myself a point for being right about no progress, but here we are.

* ***"NFTs, crypto; corporate promotion of NFTs followed by a huge backlash/abandonment."***

    **Result: +1.** I kinda want to give myself more than one point for this one, given how the whole thing collapsed [in spectacular fashion](https://uk.finance.yahoo.com/news/worst-crypto-scams-and-coverups-of-2022-050059988.html). I mean... FTX, Bitcoin, Terra, Celsius... and not just because it was speculation in the industry, mind you, but outright malfeasance and/or stupid server errors, demonstrating the lie that "the blockchain is forever". On the one hand, yay me for getting this one right, but on the other hand... yikes. Banks and other financial firms have regulation to prevent *precisely* these sorts of things from happening, and "absolutely nobody saw it coming" that these similar kinds of problems would appear in cryptocurrencies? People lost their entire life's savings out of this mess. It's more than a mess, it's a [scam](https://www.theregister.com/2022/12/20/crypto_ponzi_scheme_cofounder_pleads/), and people not neck-deep in it are starting to realize it--[including the feds](https://www.wired.com/story/crypto-web3-securities-ripple-sec-lawsuits/).

* ***"More non-developer-sales companies will build Developer Relations teams."***
    ...
    **Result: +1.** DevRel is a *hot* commodity among companies right now, even despite the layoffs. Lots of companies are looking for "Head of DevRel" candidates, signaling a desire for a "DevRel IC who can later build out the rest of the DevRel team (in a few years, when we're sure this DevRel thing is going to stick....)".
    ...
    By the way, if you're curious, [here's why every company should have a DevRel team](../2022/devrel-for-all-companies.html)...

* ***"Open-source backlash/flight/pressure grows."***

    **Result: 0.** There've been a few OSS packages that went the way of the Dodo bird, but for the most part, the OSS backlash I'd anticipated (both in terms of using OSS and on the part of OSS maintainers demanding more support or threatening to bail entirely) didn't really play out as strongly as I'd thought it would.

* ***"New programming languages are going to start the R&D cycle on languages again."***

    **Result: +1.** Hello, Carbon. Hello, Cadl. Inform7 was open-sourced (April 2022). I can feel the steam building around languages, and I don't see it going away--in fact, I think it'll get even stronger. (But at the same time, I wish the industry were a little bit more open to new players here--it's hard getting any interest in some of these.)

* ***"Some company is going to be really happy they took me up on that hypothetical in the second paragraph [about hiring me]."***

    **Result: -1.** :-( Yeah, we covered this already.
