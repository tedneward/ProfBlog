...
Note that F# does have language facilities for allowing a <a href="http://msdn.microsoft.com/en-us/library/dd233213.aspx">variable-argument list</a> to be passed, but it only works on method members:
