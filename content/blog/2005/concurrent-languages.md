...
status=published
description=In which I list out a few concurrent programming languages.
~~~~~~
...
*(**UPDATE 2021:** Check out my [research garden](http://research.tedneward.com/tags/concurrent.html) for more concurrent languages)*
