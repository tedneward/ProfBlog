...
status=published
description=Mulling out loud some rumination and thought about the rise of coding agents and the impact it has on junior developers (and the industry as a whole).
~~~~~~
...
## Coda
On the same day I published this, [a16z published a similar take](https://a16z.com/the-ai-job-apocalypse-is-a-complete-fantasy/). Theirs has a lot more data to it, and speaks to the software developer industry as a whole. It definitely bears reading on its own, and the author seems to blame the wrong folks ("Luddites" where I think the fearmongering originates with those who have a practical stake in selling AI-related tools and fantasies) but it definitely validates what I was thinking I was thinking about this whole subject.

## EDITS
*Because this topic is constantly evolving, I feel no shame in editing post-publication. The conversations around this are that raw and, sometimes, that good.*

Bruce Tate has [a great take](https://www.linkedin.com/pulse/how-better-tools-can-make-things-worse-bruce-tate-qoavf/) on the coding-agent-junior-dev discussion. I encourage anyone reading this to check out his post, but in particular the following paragraph caught my eye:
...
... and then he really hammers it home with this:
...
Thing is, code was always cheap--it was the programmer time that wasn't, and that's still the case. We're just putting our time now into different places other than writing the code, I think.
