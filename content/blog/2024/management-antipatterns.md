...
* ["The C-Buddy Manager"](../../manager-tips/c-buddy-manager.html): "Let's put a buddy of the CxO's in charge of the team"
* ["The Documentation-Abuse Manager"](../../manager-tips/doc-abuse-manager.html): "If it isn't in the spec, written down, or otherwise documented, it didn't or doesn't happen."
* ["The Flagpole Manager"](../../manager-tips/flagpole-manager.html): "I don't want to make any sort of decision, ever, so I'm going to pass this up the flagpole"
...
* ["The Metric-Abuse Manager"](../../manager-tips/metric-abuse-manager.html): "Well, we are a data-driven company, so I'm going to overindex on the data part of that."
...
* ["The Project-Manager Manager"](../../manager-tips/pm-manager.html): "Let's put the project manager in charge so they can crack the whip as necessary"
